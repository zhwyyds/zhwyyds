...
function switchToPage(target) {
  ...
  var titles = { 'dashboard': '治理总览', 'metrics': '指标库', 'metric-mgmt': '指标管理', 'roots': '词根库', 'batch-gen': '批量生成', 'review': '模型评审', 'lineage': '字段血缘', 'table-lineage': '表血缘', 'naming': '命名规范', 'caliber': '口径治理', 'scoring': '评分看板' };
